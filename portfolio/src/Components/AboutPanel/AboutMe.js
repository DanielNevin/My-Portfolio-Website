    ...
    <>
      <div className="h-auto bg-white flex justify-center items-center overflow-x-hidden">
        <div className="h-full flex flex-col items-center justify-start gap-8 font-inter font-medium">
          ...
          <p data-aos="zoom-in" data-aos-easing="sine" data-aos-duration="1000" data-aos-once="true" className="text-black text-md font-light leading-7 text-justify md:text-lg md:leading-8 lg:text-xl lg:leading-10">

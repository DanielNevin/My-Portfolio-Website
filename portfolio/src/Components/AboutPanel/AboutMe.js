...
export default function AboutMe() {
  ...
  return (
    <div data-aos="zoom-in" data-aos-easing="sine" data-aos-duration="1000" data-aos-once="true" id="about" className="h-auto flex justify-center items-center overflow-x-hidden bg-secondary rounded-2xl p-8 md:p-12 shadow-xl">
      <div className="h-full flex flex-col items-center justify-start gap-8 font-inter font-medium">
        <p className="text-[#0d0a07] text-md font-light leading-7 text-justify md:text-lg md:leading-8 lg:text-xl lg:leading-9">

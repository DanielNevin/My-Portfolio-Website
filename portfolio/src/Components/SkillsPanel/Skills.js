...
export default function Skills() {
  return(
    <div data-aos="fade-left" data-aos-easing="sine" data-aos-duration="1000" data-aos-once="true" data-aos-delay="500" className=" flex flex-col gap-8 justify-center items-center overflow-x-hidden font-inter bg-secondary p-8 md:px-16 shadow-xl">
